...
If Termux:X11 is embedded into another app (see [Termux with Termux:X11 embedded](https://raw.githubusercontent.com/termux/termux-x11/master/#termux-with-termuxx11-embedded)), replace `com.termux.x11` with that app's package name, e.g. for Termux itself:
```
