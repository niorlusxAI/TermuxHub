...
Subfinder can also be used as library and a minimal examples of using subfinder SDK is available [here](https://raw.githubusercontent.com/projectdiscovery/subfinder/dev/examples/main.go)
...
Read the usage disclaimer at [DISCLAIMER.md](https://github.com/projectdiscovery/subfinder/blob/main/DISCLAIMER.md) and [contact us](https://raw.githubusercontent.com/projectdiscovery/subfinder/dev/mailto:contact@projectdiscovery.io) for any API removal.
