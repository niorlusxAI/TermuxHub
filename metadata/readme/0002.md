...
* Hability to import and work data discovered by other tools. See [Working with other tools](https://raw.githubusercontent.com/Findomain/Findomain/master/README.md#working-with-other-tools).
